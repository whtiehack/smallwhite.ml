---
title: idea license code
comments: true
subtitle: jetbrans家族工具 激活码。
author:
  nick: smallwhite
  link: 'https://github.com/whtiehack'
date: 2019-05-05 10:22:32
tags: 
  - license
  - idea
  - jetbrains
categories: ide
permalink: jetbrain-idea-license
---
...
# 激活码激活，可以激活最新的2019.1，但是需要修改hosts。
...
判断是否生效可以通过 cmd ping ,或者 浏览器打开网址测试一下。



## 输入激活码(Activation code)，可以随便选一个：



Valid until Jan-08-2020:
...
请支持[正版](https://www.jetbrains.com/store)。

如果是学生或者老师，有免费的教育版可以用。[jetbrains学生免费授权计划](https://www.jetbrains.com/zh/student/)
...
如果你是开源项目的维护者，或者自己有开源项目，现在可以免费申请 JetBrains 便宜桶的免费授权拉。



> 只要你在 Github 上有一个满足一下条件的项目即可申请
...
![img](/images/a1e717517f7da5e2.png)

------

申请之后等待审核即可，一般为 2 天左右。审核通过之后就可以通过邮件提示去激活账号。**等明年快过期的时候可以再次申请。**
