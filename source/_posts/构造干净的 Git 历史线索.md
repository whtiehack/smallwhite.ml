...
## 理想的历史线索
 ...
 ![A successful Git branching model](/images/20160714192651599.png)
 ...
 ![实际中](/images/20160714192741163.png)
...
git pull # ！产生额外的分支
```
 ![这里写图片描述](/images/20160714192859290.png)
...
```
 ...
 ![这里写图片描述](/images/20160714192927556.png)
...
#### 避免线索“扭麻花”
 ...
 ![这里写图片描述](/images/20160714193042620.png)

 2) 但是向线上的 master push 的时候发生了冲突，因为线上的 master 比自己本地的 master 新。

 ![这里写图片描述](/images/20160714193100683.png)

 3) 然后，开发者执行了 git pull

 ![这里写图片描述](/images/20160714193120652.png)

 4) 最后，开发者愉快的 git push ，线上的 master 分支将会和本地一样

 ![这里写图片描述](/images/20160714194147947.png)
...
```
 ...
 ![这里写图片描述](/images/20160714193144334.png)
